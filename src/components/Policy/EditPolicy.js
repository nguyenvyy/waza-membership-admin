...
export const EditPolicy = ({
    ...
    const handleEditPolicy = () => {
        let editedPolicyCoppy = {...editedPolicy}
        editedPolicyCoppy.policy_name = editedPolicy.policy_name.trim()
        dispatch(requestEditComboPolicy(editedPolicyCoppy)).then(res => {
            setIsFetching(false)
